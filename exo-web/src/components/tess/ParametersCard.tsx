...
interface ParametersCardProps {
  primaryParams: ParamTess[];
  extraParams: ParamTess[];
...
//   extraParams,
  ...
  switch (paramId) {
    case 'pl_orbper': return { min: 0, max: 500, step: 0.1 };
    case 'pl_trandurh': return { min: 0, max: 24, step: 0.1 };
    case 'pl_trandep': return { min: 0, max: 1, step: 0.001 };
    case 'pl_rade': return { min: 0.1, max: 20, step: 0.1 };
    case 'pl_insol': return { min: 0, max: 500, step: 0.1 };
    case 'pl_eqt': return { min: 200, max: 3000, step: 10 };
    case 'st_teff': return { min: 2500, max: 10000, step: 50 };
    case 'st_logg': return { min: 0, max: 6, step: 0.1 };
    case 'st_rad': return { min: 0.1, max: 20, step: 0.1 };
