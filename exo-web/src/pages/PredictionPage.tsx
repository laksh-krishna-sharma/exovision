...
const PredictionPage: React.FC = () => {
  ...
  const handleStart = () => {
    ...
    const requiredDefaults: PredictionParams = {
      ...
      koi_period: 0.0, koi_period_err1: 0.00000582, koi_period_err2: -0.00000582,
      koi_time0bk: 134.51415, koi_time0bk_err1: 0.00041, koi_time0bk_err2: -0.00041,
      koi_impact: 0.586, koi_impact_err1: 0.115, koi_impact_err2: -0.115,
      koi_duration: 2.8092, koi_duration_err1: 0.0094, koi_duration_err2: -0.0094,
      koi_depth: 2793.0, koi_depth_err1: 29.0, koi_depth_err2: -29.0,
      koi_prad: 0.0, koi_prad_err1: 0.11, koi_prad_err2: -0.11,
      koi_teq: 0.0, koi_teq_err1: 19, koi_teq_err2: -19,
      koi_insol: 0.0, koi_insol_err1: 5.4, koi_insol_err2: -5.4,
      koi_model_snr: 96.2, koi_tce_plnt_num: 1,
      koi_steff: 0.0, koi_steff_err1: 81, koi_steff_err2: -81,
      koi_slogg: 4.467, koi_slogg_err1: 0.064, koi_slogg_err2: -0.064,
      koi_srad: 0.0, koi_srad_err1: 0.105, koi_srad_err2: -0.105,
      ra: 291.93423, dec: 48.141651, koi_kepmag: 15.347,
    };
