  ...
  >
    ...
    <div className="flex flex-col gap-4">
      <Input
        ...
        type="text"
        placeholder="Name"
        className="bg-white/5 text-white placeholder-white/50 border border-white/20 rounded-lg"
      />
      <Input
        value={email}
  ...
  >
    ...
    <div>
      ...
      <p className="text-white/80 leading-relaxed text-base md:text-lg max-w-3xl mx-auto">
        ...
        other stars, but some free-floating exoplanets, called rogue planets, are
        untethered to any star. We’ve confirmed nearly 6,000 exoplanets, out of
        the billions that we believe exist.
      </p>
    </div>

    {/* Section 2 */}
    <div>
      <h3 className="mb-6 text-2xl md:text-3xl font-semibold">Types of Exoplanets</h3>
      <img
    ...
    <div className="text-left max-w-3xl space-y-4">
      <p className="text-white/80 text-sm md:text-lg leading-relaxed">
        <span className="block mb-3">
          <span className="font-semibold text-white">Gas Giants:</span> Planets the size
          of Saturn or Jupiter, or much larger. Some are "hot Jupiters" orbiting very
          close to their stars, reaching scorching temperatures.
        </span>

        <span className="block mb-3">
          <span className="font-semibold text-white">Neptunian Planets:</span> Similar in
          size to Neptune or Uranus, with atmospheres dominated by hydrogen and helium
          and rocky cores.
        </span>

        <span className="block mb-3">
          <span className="font-semibold text-white">Super-Earths:</span> Rocky worlds,
          more massive than Earth but lighter than Neptune, with or without
          atmospheres.
        </span>

        <span className="block">
          <span className="font-semibold text-white">Terrestrial Planets:</span> Earth-sized
          or smaller rocky planets, made of silicate, water, or carbon. Some may host
          atmospheres, oceans, or even conditions suitable for life.
        </span>
      </p>
    </div>
  </motion.div>
